(function () {
  ...
  function readtimeMarkup(document) {
    ...
    return '<span class="post-card-readtime"><svg class="site-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="9"></circle><path d="M12 7v5l3 2"></path></svg>' +
  ...
  function itemMarkup(document) {
    var image = document.teaser
      ? '<a class="category-post-item__image" href="' + escapeHtml(document.url) + '" tabindex="-1" aria-hidden="true">' +
          '<img src="' + escapeHtml(document.teaser) + '" alt="" width="320" height="180" loading="lazy">' + readtimeMarkup(document) + "</a>"
